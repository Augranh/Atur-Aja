<section class="hero-section py-12 md:py-20" style="background-color: var(--bg-primary);">
  <div class="container mx-auto px-4">
    <div class="flex flex-col-reverse items-center justify-between gap-10 md:flex-row">
      <div class="w-full space-y-6 text-center md:w-1/2 md:text-left">
        <h1 class="text-3xl leading-tight font-bold md:text-5xl" style="color: var(--text-primary);">
          Manage Tasks & Projects <br class="hidden md:block" />
          <span style="color: var(--accent-2);">Effortlessly</span>
        </h1>
        ...
        <div class="mt-8 flex items-center gap-4 pt-8 text-sm" style="border-top: 1px solid var(--border-color); color: var(--text-secondary);">
          <div class="flex items-center gap-2">
            <svg class="h-5 w-5" style="color: #00a500ff;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
