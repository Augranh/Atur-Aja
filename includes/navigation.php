<?php
  $navigation_items = [
      ...
      ["label" => "Solutions", "href" => "index.php#solution"],
      ["label" => "Plans", "href" => "index.php#plans"],
      ["label" => "Resources", "href" => "index.php#resources"],
  ];
?>
    ...
    <div class="flex h-16 items-center justify-between">
      ...
      <div class="hidden items-center gap-8 md:flex">
        ...
        <div class="flex gap-4">
          <a href="login.php" class="btn-login px-4 py-2 text-sm font-medium transition" style="color: var(--text-secondary);" onmouseover="this.style.color='var(--accent-2)'" onmouseout="this.style.color='var(--text-secondary)'">Login</a>
          <a href="signup.php" class="btn-register rounded-lg px-4 py-2 text-sm font-medium text-white transition" style="background-color: var(--accent-1);" onmouseover="this.style.backgroundColor='var(--accent-2)'" onmouseout="this.style.backgroundColor='var(--accent-1)'">Register</a>
        </div>
      </div>
  ...
  <div id="mobile-menu" class="hidden border-b md:hidden" style="border-color: var(--border-color); background-color: var(--bg-primary);">
    <div class="flex flex-col space-y-1 px-4 pt-2 pb-4">
      ...
      <div class="mt-4 flex flex-col gap-3 pt-4" style="border-top: 1px solid var(--border-color);">
        <a href="login.php" class="block rounded-lg px-4 py-2 text-center text-base font-medium transition" style="border: 1px solid var(--border-color); color: var(--text-secondary);" onmouseover="this.style.backgroundColor='var(--bg-secondary)'" onmouseout="this.style.backgroundColor='transparent'">Login</a>
        <a href="signup.php" class="block rounded-lg px-4 py-2 text-center text-base font-medium text-white transition" style="background-color: var(--accent-1);" onmouseover="this.style.backgroundColor='var(--accent-2)'" onmouseout="this.style.backgroundColor='var(--accent-1)'">Register</a>
      </div>
    </div>
  </div>
  </nav>
